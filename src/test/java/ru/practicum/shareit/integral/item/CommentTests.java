...
public class CommentTests {
    ...
    public void getCommentsToSingleItemTest() {
        ...
        bookingService.updateBounds(bookingId1, TestUtils.fromOffset(-4L), TestUtils.fromOffset(-3L));
        ...
        bookingService.updateBounds(bookingId2, TestUtils.fromOffset(-6L), TestUtils.fromOffset(-5L));
